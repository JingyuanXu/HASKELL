...
instance Bifunctor ListE where
 bimap f g NilE = NilE
 bimap f g (ConsL a p)= ConsL (f a)(bimap f g p)
 bimap f g (ConsR b p)= ConsR (g b)(bimap f g p)
